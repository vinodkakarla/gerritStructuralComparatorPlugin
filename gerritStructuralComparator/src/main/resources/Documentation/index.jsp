...
<link href="css/dropdown.css" title="default" rel="stylesheet"
	type="text/css" />
	...
	<div class="container">
		...
		<header class="header">
			...
			<div class="profileSection">
				...
				<p role="modified">
					Uploaded : <span>Apr 1, 2013 2:04 AM</span> Updated : <span>Apr
						1, 2013 2:04 AM</span>
				</p>
			...
			<div class="showContent">
				...
				<div class="content">
					<div class="headerContent">
						<div class="ownerInfo">
							<div role="owner-name">
								<img src="images/profilePic.png" /> <span> <a href="#">Steffen
										Pingel</a> OWNER
								</span>
							</div>
							...
							<div role="owner-info">
								<div class="lFloat col col1">
									...
									<div class="ownerInfoRow">
										<label>Project</label>
										<p>
											<a href="#">mylyn/org.eclipse.mylyn.incubator</a>
										</p>
									</div>
		...
		<section class="main">
			<div class="mainContianer">
				...
				<div class="playGround">
					...
					Gold futures in India, the world's biggest buyer of the metal,
					dropped nearly 3 percent to hit their lowest level in 15-1/2
					months, mirroring losses in the world market. (Photo: Reuters
					Pictures) Gold futures in India, the world's biggest buyer of the
					metal, dropped nearly 3 percent to hit their lowest level in 15-1/2
					months, mirroring losses in the world market. (Photo: Reuters
					Pictures) Gold futures in India, the world's biggest buyer of the
					metal, dropped nearly 3 percent to hit their lowest level in 15-1/2
					months, mirroring losses in the world market. (Photo: Reuters
					...
					months, mirroring losses in the world market. (Photo: Reuters
					Pictures)
					<%= 500*10 %><button onclick="createWindow()">It is off!</button>
				</div>
			</div>
